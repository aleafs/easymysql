...
exports.create = function (options) {
  ...
  var _querywithouttimeout = function (sql, callback) {
    var s = _readonly(sql) ? READONLY : WRITABLE;
    var i, c, t = [];
...
var Client = function (config, options) {
