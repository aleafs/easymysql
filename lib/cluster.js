...
var Transact = require(__dirname + '/transact.js');
...
exports.create = function (options) {
  ...
  Cluster.prototype.startTransact = function () {
    var p = backups[rwlists[(++rwcount) % rwlists.length]];
    var c = p.getConn();
    return Transact.create(c, p);
  }
